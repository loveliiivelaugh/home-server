 ...
 *     responses:
 */
openfitnessRoutes.get('/get-exercises', handleAdminOnly, async (c: Context) => {
 ...
 *     responses:
 */
openfitnessRoutes.get('/get-foods', handleAdminOnly, async (c: Context) => {
 ...
 *     responses:
 */
openfitnessRoutes.get('/get-single-food', handleAdminOnly, async (c: Context) => {
